...
export default function Navbar() {
    return (
        <nav className="fixed top-8 left-1/2 -translate-x-1/2 z-[100] w-[80%] max-w-6xl px-16 py-6 backdrop-blur-3xl bg-black/60 border border-zinc-800/80 shadow-2xl transition-all hover:bg-black/90 group flex items-center">
            <div className="w-[20%] text-2xl font-black tracking-tightest text-white uppercase flex items-center gap-4">
                <div className="w-6 h-6 bg-blue-600 group-hover:bg-purple-600 transition-all duration-700" />
                FocusFlow
            </div>

            <div className="flex-1 flex justify-center items-center gap-10 text-xs font-black uppercase tracking-widest">
            ...
            {/* Spacer to keep center truly centered if logo is wider than end area */}
            <div className="w-[20%]" />
        </nav>
    );
}
