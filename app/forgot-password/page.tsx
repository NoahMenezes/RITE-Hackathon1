            ...
            <main className="flex items-center justify-center pt-56 pb-40 px-12 relative z-10">
                <div className="w-full max-w-2xl bg-zinc-950/80 backdrop-blur-3xl border border-zinc-900 shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="p-24 space-y-16">
                        ...
                        <p className="text-xl text-zinc-400 font-bold uppercase tracking-tight max-w-sm">Enter your identity UID, and we will transmit a secure recovery link.</p>

                        <form className="space-y-12">
                            <div className="space-y-6">
                                <label className="text-xs font-black text-zinc-600 uppercase tracking-widest pl-1">Identity UID (Email)</label>
                                <input type="email" placeholder="ACCESS@PROTO.NET" className="w-full bg-transparent border-b border-zinc-800 p-6 text-2xl font-black text-white focus:border-red-500 transition-all outline-none rounded-none placeholder:text-zinc-800" />
                            </div>
